...
// Keypad 4x4 mapping and object
static byte rowPins[4] = {32, 33, 25, 4};
static byte colPins[4] = {27, 12, 13, 15};
char keys[4][4] = {
    {'1','2','3','A'},
    {'4','5','6','B'},
    {'7','8','9','C'},
...
// Message composition (T9-like multi-tap input)
namespace Compose {
